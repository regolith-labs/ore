...
pub const CLAIM_ORE_DISCRIMINATOR: u8 = 4;
...
impl ClaimOre {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let data = ClaimOreInstructionData::new().try_to_vec().unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct ClaimOreInstructionData {
            discriminator: u8,
      }

impl ClaimOreInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: 4,
                  }
...
impl Default for ClaimOreInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
/// Instruction builder for `ClaimOre`.
///
/// ### Accounts:
///
...
#[inline(always)]
  ...
  /// `claim_ore` CPI accounts.
  pub struct ClaimOreCpiAccounts<'a, 'b> {
...
/// `claim_ore` CPI instruction.
pub struct ClaimOreCpi<'a, 'b> {
...
impl<'a, 'b> ClaimOreCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_account_info::AccountInfo<'a>,
          accounts: ClaimOreCpiAccounts<'a, 'b>,
          ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `ClaimOre` via CPI.
///
/// ### Accounts:
///
                      ///   0. `[writable, signer]` signer
          ...
          ///   8. `[]` associated_token_program
#[derive(Clone, Debug)]
pub struct ClaimOreCpiBuilder<'a, 'b> {
  instruction: Box<ClaimOreCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> ClaimOreCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(ClaimOreCpiBuilderInstruction {
      __program: program,
              signer: None,
              miner: None,
              mint: None,
...
#[derive(Clone, Debug)]
struct ClaimOreCpiBuilderInstruction<'a, 'b> {
